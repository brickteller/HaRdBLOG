...
Just start building.  The key to doing anything well is being willing do it poorly, over and over, until you get better.  Your first new creations you make might not look like some of the impressive builds you've seen from others, but keep on building and you'll learn and get better each time. 


#Learn from Official LEGO Sets
Assembling official LEGO sets from instructions, especially the ones with higher age ranges on the box, is one great way to introduce yourself to building techniques and some of the new parts available. And you don't have to treat the copleted model as the end of the process.  Consider if there is a a way the set could have, and then give it a try.  Some ideas:
...
- Enclose a building originially built with an open back.
...
*[The Brick Builder's Handbook](https://brickbuildershandbook.com/) by Deepak Shenoy (Deep Shen) has several great articles on building techniques (and the math behind them, if you're into that sort of thing) that he uses in large architectural builds.  Also, he does some great mosaics.  Check out his [Instagram] feed, or read the feature on him at [he Brothers Brick](https://www.brothers-brick.com/)
